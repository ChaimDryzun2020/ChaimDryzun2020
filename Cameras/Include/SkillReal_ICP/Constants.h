...
// Sigmoid constants for angular weight calculation
const float ANGULAR_B = 12.5f;
const float ANGULAR_X0 = 1.05f;

// Constants for STD weight calculation
const float STD_A = 0.1625f;
const float STD_B = 0.0875f;
const float STD_MAX_DIST = 1.5f;
const float STD_MIN_WEIGHT = 2.197f;
